...
[Paper](https://arxiv.org/abs/2502.13923) · [PDF](https://arxiv.org/pdf/2502.13923) · [Issues](https://github.com/StaryMoon/Qwen2-5-VL-Unofficial/issues) · [Release](https://github.com/StaryMoon/Qwen2-5-VL-Unofficial/releases)
...
```bash
git clone https://github.com/StaryMoon/Qwen2-5-VL-Unofficial.git
cd Qwen2-5-VL-Unofficial
python -m venv .venv
...
```python
import torch
from qwen2_5_vl_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="vlm", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from qwen2_5_vl_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2502.13923) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2502.13923) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2502.13923) |
...
@article{Qwen25VL_2025,
  ...
  author  = {Shuai Bai and Keqin Chen and Xuejing Liu and Jialin Wang and Wenbin Ge and Sibo Song and Kai Dang and Peng Wang and others},
...
- Thanks to the authors of **Qwen2.5-VL Technical Report** for the original research.
...
pytorch, unofficial-implementation, reproduction, qwen, vision-language, mllm, document-understanding, visual-agent
